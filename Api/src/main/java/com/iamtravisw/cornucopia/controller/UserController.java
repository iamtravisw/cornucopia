...
public class UserController {
    ...
    @GetMapping("/retrieve/id/{userId}")
    public ResponseEntity<?> getUserById(@Validated @PathVariable Long userId) {
    ...
    public ResponseEntity<?> getUserByUserName(@Validated @PathVariable String userName) {
    ...
    public ResponseEntity<?> updateUser(@Validated @RequestBody User user) {
        ...
        if(user.getBiography() != storedUser.getBiography()){
            storedUser.setBiography(user.getBiography());
        }
        if(user.getTagLine() != storedUser.getTagLine()){
